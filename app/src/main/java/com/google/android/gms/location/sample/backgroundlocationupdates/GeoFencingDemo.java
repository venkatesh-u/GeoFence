...
/**
 * Created by RajeshT on 05-10-2017.
 */
...
//        String isDataStored= sharedPreferences.getString("latitude", "notYetStored");
//        if (!isDataStored.equals("notYetStored")){
//            etLat.setText((int) Double.parseDouble( sharedPreferences.getString("latitude", null ) ));
//            etLong.setText((int) Double.parseDouble(sharedPreferences.getString("longitude", null)));
//            etRadius.setText(Integer.parseInt(sharedPreferences.getString("latitude", "100")));
//
//        }else {
//
//            LatLng latLng = Constants.AREA_LANDMARKS.get(Constants.GEOFENCE_ID_TECH_M);
//
//            etLat.setText((int) latLng.latitude);
//            etLong.setText((int) latLng.longitude);
//            etLat.setText((int) Constants.GEOFENCE_RADIUS_IN_METERS);
//
//        }
